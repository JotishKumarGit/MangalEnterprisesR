...
import new_img_1 from '../assets/Untitled design.png';
            ...
            <div id="carouselExampleCaptions" className="carousel slide">
                ...
                <div className="carousel-inner">
                    <div className="carousel-item active">
                        <img src={new_img_3} className="d-block w-100" alt="..." style={{ height: '500px', objectFit: 'cover' }} />
                    ...
                    <div className="carousel-item">
                        <img src={new_img_1} className="d-block w-100" alt="..." style={{ height: '500px', objectFit: 'cover' }} />
                        {/* <div className="carousel-caption d-none d-md-block" style={{ backgroundColor: 'rgba(0, 0, 0, 0.6)', padding: '10px', borderRadius: '5px' }}>
